...
export const testimonials = [
    {
        text: `Vishard is <strong>seriously</strong> one of the most dedicated people I've worked with. His drive to learn and build is <strong>unmatched</strong>.`,
        author: 'Peer Review',
        role: 'Thapar University',
    },
];

export const motto = {
    text: 'Veni<br/>Vidi<br/><span class="text-accent">Vici</span>',
