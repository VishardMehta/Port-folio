...
const defaultMarkers = [
    // Punjab, India
    { id: 'pulse-punjab', location: [31.15, 75.34], delay: 0 },
];
...
export default function GlobePulse({
    ...
    return (
        <div
            className={className}
            style={{ position: 'relative', width: '100%', height: '100%', aspectRatio: '1 / 1', userSelect: 'none' }}
        >
            <style>{`
                ...
                >
                    ...
                    <span
                        style={{
                            ...
                            background: '#eb5939',
                            borderRadius: '50%',
                            boxShadow: '0 0 0 3px #111, 0 0 0 5px #eb5939',
                        }}
                    />
                </div>
            ))}
